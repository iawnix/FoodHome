...
mixin _$HouseholdMember {
 ...
 String get id; String get displayName; String get roleLabel;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is HouseholdMember&&(identical(other.id, id) || other.id == id)&&(identical(other.displayName, displayName) || other.displayName == displayName)&&(identical(other.roleLabel, roleLabel) || other.roleLabel == roleLabel));
}


@override
int get hashCode => Object.hash(runtimeType,id,displayName,roleLabel);

@override
String toString() {
  return 'HouseholdMember(id: $id, displayName: $displayName, roleLabel: $roleLabel)';
}
...
@useResult
$Res call({
 String id, String displayName, String roleLabel
});
...
/// Create a copy of HouseholdMember
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? displayName = null,Object? roleLabel = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String displayName,  String roleLabel)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _HouseholdMember() when $default != null:
return $default(_that.id,_that.displayName,_that.roleLabel);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String displayName,  String roleLabel)  $default,) {final _that = this;
switch (_that) {
case _HouseholdMember():
return $default(_that.id,_that.displayName,_that.roleLabel);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String displayName,  String roleLabel)?  $default,) {final _that = this;
switch (_that) {
case _HouseholdMember() when $default != null:
return $default(_that.id,_that.displayName,_that.roleLabel);case _:
  return null;
...
class _HouseholdMember implements HouseholdMember {
  const _HouseholdMember({required this.id, required this.displayName, required this.roleLabel});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _HouseholdMember&&(identical(other.id, id) || other.id == id)&&(identical(other.displayName, displayName) || other.displayName == displayName)&&(identical(other.roleLabel, roleLabel) || other.roleLabel == roleLabel));
}
...
/// Create a copy of HouseholdMember
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? displayName = null,Object? roleLabel = null,}) {
